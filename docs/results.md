...
Ⅰ级最优区 16,022 个 240 m 像元（最终存档口径，点数演变见第四节注）；最优路径起点 (44,760, 10,920) → PSR 边缘采样点 (40,920, 10,920)，全长 4.039 km，绕路系数 1.052，危险区穿越 0。
...
| Ⅰ级最优选址像元 | 16,022 个（最终存档口径；2026-08-03 P0 坐标修复阶段早期迭代曾记 5,214，其底层 suitability 未归档，详见 tests/解耦与精度验证报告.md §L5.2） |
